...
namespace Q211932.nwindDataSetTableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`CustomerID`, `OrderDate`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `CustomerID` = ?, `OrderDate` = ? WHERE ((`OrderID` = ?) AND " +
                "((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)) AND ((? = 1 AND `OrderD" +
                "ate` IS NULL) OR (`OrderDate` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Q211932.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT OrderID, CustomerID, OrderDate FROM Orders";
        ...
        public virtual int Delete(int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate) {
        ...
        public virtual int Update(string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate) {
            if ((CustomerID == null)) {
