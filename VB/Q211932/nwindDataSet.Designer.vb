...
Namespace Q211932
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class OrdersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddOrdersRow(ByVal CustomerID As String, ByVal OrderDate As System.DateTime) As OrdersRow
				Dim rowOrdersRow As OrdersRow = (CType(Me.NewRow(), OrdersRow))
				Dim columnValuesArray() As Object = { Nothing, CustomerID, OrderDate}
	...
	End Class
End Namespace
Namespace Q211932.nwindDataSetTableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Orders` WHERE ((`OrderID` = ?) AND ((? = 1 AND `CustomerID` IS NULL)" & " OR (`CustomerID` = ?)) AND ((? = 1 AND `OrderDate` IS NULL) OR (`OrderDate` = ?" & ")))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`CustomerID`, `OrderDate`) VALUES (?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `CustomerID` = ?, `OrderDate` = ? WHERE ((`OrderID` = ?) AND " & "((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)) AND ((? = 1 AND `OrderD" & "ate` IS NULL) OR (`OrderDate` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT OrderID, CustomerID, OrderDate FROM Orders"
		...
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_OrderDate As Global.System.Nullable(Of Global.System.DateTime)) As Integer
			...
			If (Original_OrderDate.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CDate(Original_OrderDate.Value))
			Else
		...
		Public Overridable Function Insert(ByVal CustomerID As String, ByVal OrderDate As Global.System.Nullable(Of Global.System.DateTime)) As Integer
			...
			If (OrderDate.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(1).Value = (CDate(OrderDate.Value))
			Else
		...
		Public Overridable Function Update(ByVal CustomerID As String, ByVal OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_OrderDate As Global.System.Nullable(Of Global.System.DateTime)) As Integer
			If (CustomerID Is Nothing) Then
			...
			End If
			If (OrderDate.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CDate(OrderDate.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(2).Value = (CInt(Fix(Original_OrderID)))
			If (Original_CustomerID Is Nothing) Then
			...
			If (Original_OrderDate.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CDate(Original_OrderDate.Value))
			Else
